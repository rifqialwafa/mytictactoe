//stores player turns
    ...
    document.getElementById("reset").addEventListener("click", function() {
      ...
      document.getElementById("pxoyt").style.display = "block";
    ...
    document.getElementById("cScore").addEventListener("click", function () {
        ...
        let scoreO =  document.getElementById('scoreO');
          localStorage.removeItem(CACHE_KEY_X);
          localStorage.removeItem(CACHE_KEY_O);
          scoreX.innerText = "0";
          scoreO.innerText = "0";
    });
    ...
    function showWinner(x, y, z) {
      boxes[x].style.background = "#333";
      boxes[x].style.color = "lightblue";
      boxes[y].style.background = "#333";
      boxes[y].style.color = "lightblue";
      boxes[z].style.background = "#333";
      boxes[z].style.color = "lightblue";
      document.getElementById("winner").innerHTML = currentPlayer == "x" ? "O" : "X";
      document.getElementById("message").style.display = "block";
      document.getElementById("pxoyt").style.display = "none";
